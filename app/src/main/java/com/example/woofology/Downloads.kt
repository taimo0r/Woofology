...
class Downloads : AppCompatActivity(), onItemClick {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomNavigationView.selectedItemId = R.id.downloaded_images_activity
        bottomNavigationView.setOnNavigationItemSelectedListener { item ->
            when (item.itemId) {
//                R.id.find_dog_activity -> navigateTo(MyDogsActivity::class.java)
//                R.id.list_activity -> navigateTo(AllBreeds::class.java)

                R.id.downloaded_images_activity -> true
                else -> false
            }
        }
    }
